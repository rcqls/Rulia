...
Let us notice that there exist alternatives `R` package like [`JuliaCall`](https://github.com/Non-Contradiction/JuliaCall).
...
<details>
<summary><h1>The user-friendly <code>jl()</code> function</h1></summary>
...
<details><summary><h2>`jl()` as evaluation of `julia` expressions</h2></summary>
...
<details><summary><h2>`jl()` as `julia` converter of `R` objects</h2></summary>
...
<details><summary><h2>`jl()` function to call `julia` function inside `R` system</h2></summary>
...
<details><summary><h2>Conversion `julia` to `R`</h2></summary>

 </details>

<details><summary><h2>Rulia in the statistic context</h2></summary>
...
<details>
<summary><h1>Rulia in low level mode</h1></summary>
TODO
</details>
