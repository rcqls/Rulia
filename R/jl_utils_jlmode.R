...
"%<:%" <- function(a, b) {args <- jlvalue_eval_rexprs(substitute(list(a,b)), parent_envir=parent.frame());jl(`<:`)(args[[1]],args[[2]])}

"%isa%" <- function(a, b) {args <- jlvalue_eval_rexprs(substitute(list(a,b)), parent_envir=parent.frame());jl(isa)(args[[1]],args[[2]])}
